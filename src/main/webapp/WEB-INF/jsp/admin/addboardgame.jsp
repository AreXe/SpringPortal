        ...
        <div class="card-body" align="center">
            ...
            <sf:form id="boardGameForm" action="${pageContext.request.contextPath}/admin/addnewboardgame" modelAttribute="boardGame" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" pattern="[0-9]{4}" maxlength="4" name="releaseYear" id="releaseYear" placeholder="Release year" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" pattern="[0-9]{2}" maxlength="2" name="minAge" id="minAge" placeholder="Min age">
                    </div>
                </div>
